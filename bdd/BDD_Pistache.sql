...
-- Insertion des ressources PDF pour chaque jeu
INSERT INTO ressource (id_jeux, type_ressource, url, titre)
VALUES 
    ((SELECT id_jeux FROM jeux WHERE nom = "Les Colons de Catane"), 'pdf', 'assets/pdf/les_colons_de_catane.pdf', 'Règles du jeu Les Colons de Catane'),
    ((SELECT id_jeux FROM jeux WHERE nom = "Dixit"), 'pdf', 'assets/pdf/dixit.pdf', 'Règles du jeu Dixit'),
    ((SELECT id_jeux FROM jeux WHERE nom = "Pandemic"), 'pdf', 'assets/pdf/pandemic-regle.pdf', 'Règles du jeu Pandemic'),
    ((SELECT id_jeux FROM jeux WHERE nom = "7 Wonders"), 'pdf', 'assets/pdf/7_wonders.pdf', 'Règles du jeu 7 Wonders'),
    ((SELECT id_jeux FROM jeux WHERE nom = "Uno"), 'pdf', 'assets/pdf/Uno.pdf', 'Règles du jeu Uno'),
    ((SELECT id_jeux FROM jeux WHERE nom = "Cluedo"), 'pdf', 'assets/pdf/cluedo.pdf', 'Règles du jeu Cluedo'),
    ((SELECT id_jeux FROM jeux WHERE nom = "Exploding Kittens"), 'pdf', 'assets/pdf/exploding_kittens.pdf', 'Règles du jeu Exploding Kittens'),
    ((SELECT id_jeux FROM jeux WHERE nom = "Azul"), 'pdf', 'assets/pdf/azul.pdf', 'Règles du jeu Azul'),
    ((SELECT id_jeux FROM jeux WHERE nom = "Codenames"), 'pdf', 'assets/pdf/codenames.pdf', 'Règles du jeu Codenames'),
    ((SELECT id_jeux FROM jeux WHERE nom = "Takenoko"), 'pdf', 'assets/pdf/takenoko.pdf', 'Règles du jeu Takenoko'),
    ((SELECT id_jeux FROM jeux WHERE nom = "Mille Bornes"), 'pdf', 'assets/pdf/MilleBorne.pdf', 'Règles du jeu Mille Bornes'),
    ((SELECT id_jeux FROM jeux WHERE nom = "Scrabble"), 'pdf', 'assets/pdf/scrabble.pdf', 'Règles du jeu Scrabble');

-- Insertion des ressources vidéo pour chaque jeu
INSERT INTO ressource (id_jeux, type_ressource, url, titre)
VALUES 
    ((SELECT id_jeux FROM jeux WHERE nom = "Les Colons de Catane"), 'video', 'https://www.youtube.com/watch?v=RLSoEbybRYI', 'Tutoriel vidéo Les Colons de Catane'),
    ((SELECT id_jeux FROM jeux WHERE nom = "Dixit"), 'video', 'https://www.youtube.com/watch?v=5evzrBE1gcs', 'Tutoriel vidéo Dixit'),
    ((SELECT id_jeux FROM jeux WHERE nom = "Pandemic"), 'video', 'https://www.youtube.com/watch?v=dOvD9IDfZuY', 'Tutoriel vidéo Pandemic'),
    ((SELECT id_jeux FROM jeux WHERE nom = "7 Wonders"), 'video', 'https://www.youtube.com/watch?v=0EI9OkSnVeM', 'Tutoriel vidéo 7 Wonders'),
    ((SELECT id_jeux FROM jeux WHERE nom = "Uno"), 'video', 'https://www.youtube.com/watch?v=kR48Pt6fYDY', 'Tutoriel vidéo Uno'),
    ((SELECT id_jeux FROM jeux WHERE nom = "Cluedo"), 'video', 'https://www.youtube.com/watch?v=PJjS824OrU0', 'Tutoriel vidéo Cluedo'),
    ((SELECT id_jeux FROM jeux WHERE nom = "Exploding Kittens"), 'video', 'https://www.youtube.com/watch?v=eMWmZxuMmjk', 'Tutoriel vidéo Exploding Kittens'),
    ((SELECT id_jeux FROM jeux WHERE nom = "Azul"), 'video', 'https://www.youtube.com/watch?v=C9zOpikMSzA', 'Tutoriel vidéo Azul'),
    ((SELECT id_jeux FROM jeux WHERE nom = "Codenames"), 'video', 'https://www.youtube.com/watch?v=Bi5q9YuCEQw', 'Tutoriel vidéo Codenames'),
    ((SELECT id_jeux FROM jeux WHERE nom = "Takenoko"), 'video', 'https://www.youtube.com/watch?v=iIct2o0xtp8', 'Tutoriel vidéo Takenoko'),
    ((SELECT id_jeux FROM jeux WHERE nom = "Mille Bornes"), 'video', 'https://www.youtube.com/watch?v=Pie95ucq6Vw', 'Tutoriel vidéo Mille Bornes'),
    ((SELECT id_jeux FROM jeux WHERE nom = "Scrabble"), 'video', 'https://www.youtube.com/watch?v=T_t97J8h8F4', 'Tutoriel vidéo Scrabble');
...
VALUES
    ...
    ("Grand Festival Ludique", "Une journée complète pour découvrir 4 univers de jeux différents ! Stratégie avec Azul, coopération avec Pandemic, déduction avec Codenames et fun garanti avec Exploding Kittens. Un événement parfait pour tous les âges et tous les goûts !", "2025-07-20", "2025-07-20", 16, "journée");
...
WHERE 
    ...
    (j.nom IN ("Cluedo", "Codenames", "Scrabble") AND e.titre = "Week-end Mystères & Déductions") or
    -- Grand Festival Ludique
    (j.nom IN ("Azul", "Pandemic", "Codenames", "Exploding Kittens") AND e.titre = "Grand Festival Ludique");
