...
try {
    ...
    foreach ($evenements as &$evenement) {
        $sql = "SELECT COUNT(*) as nb_inscrits FROM inscription WHERE id_evenement = :id_evenement";
        $stmt = $conn->prepare($sql);
        $stmt->execute([':id_evenement' => $evenement['id_evenement']]);
                ...
                <?php foreach ($evenements as $evenement) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="suppression.php?id=<?php echo $evenement['id_evenement']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet événement ?');">Supprimer</a>
